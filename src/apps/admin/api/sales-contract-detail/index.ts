...
/** 销售合同M明细渲染字段 */
export function salesContractDetailNameRender(params: { sales_contract_id: SalesContract["id"] }) {
  return fetch.GET<RenderNames[]>(fetch.base(`/api/sales-contract-detail/render`), params);
}
