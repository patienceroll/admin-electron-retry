...
import { getSalesDeliverDetailList } from "src/apps/admin/api/sales-deliver-detail";
...
export default function (
  ...
  const table = useSearchTable(getSalesDeliverDetailList);
  ...
  useEffect(() => {
    table.extraParams.current.sales_deliver_id = id;
    table.reload();
  }, []);
