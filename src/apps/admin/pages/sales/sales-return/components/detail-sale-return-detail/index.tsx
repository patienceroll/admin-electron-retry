...
import { getSalesReturnDetailList } from "src/apps/admin/api/sales-return-detail";
import useSearchTable from "src/hooks/use-search-table";
import Money from "src/util/money";
import useColumnState from "src/hooks/use-column-state";

export default function (
  props: Pick<SalesReturn, "id"> & {
  ...
  const table = useSearchTable(getSalesReturnDetailList);
  ...
  useEffect(() => {
    table.extraParams.current.sales_return_id = id;
    table.reload();
  }, []);

  const columnState = useColumnState("salesReturnDetail_OrderDetail", column);
